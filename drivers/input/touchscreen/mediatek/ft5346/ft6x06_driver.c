...
//@xuchunsheng added start for distingish the IC type with specific project name in 19/09/2015
#if defined(L5460_PROJECT_SUPPORT)
#define DRIVER_NAME "FT5346I"	//for s4710 ,use ft5446i IC
#else
#define DRIVER_NAME "FT5446I"
#endif
//@xuchunsheng added ended
...
static void tpd_suspend(struct early_suspend *h)
 {
	...
	const char data = 0x01;
        //@xuchunsheng changed start for recongnize L5460 gesture type with other project in 08/28/2015
        #ifdef L5460_FT5436_GESTURE_TYPE
        const char dataEnDoubleclick = 0x10;
        #else
	const char dataEnDoubleclick = 0x10;
        #endif
        //@xuchunsheng changed end in 08/28/2015
	#ifdef TGESETURE_APP
        //@xuchunsheng changed start for recongnize L5460 gesture type with other project in 08/28/2015
        #ifdef L5460_FT5436_GESTURE_TYPE
