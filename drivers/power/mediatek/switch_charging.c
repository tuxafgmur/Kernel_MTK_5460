...
static void set_jeita_charging_current(void)
{
	...
	battery_xlog_printk(BAT_LOG_CRTI, "[BATTERY]set_jeita_charging_current:g_temp_status=%d, g_temp_CC_value=%d,g_temp_input_CC_value=%d\r\n", g_temp_status,g_temp_CC_value,g_temp_input_CC_value);
}
