...
#define AF_MOVE_SLOWLY //yixuhong 20150901 add ,af noise
...
inline static int move_dw9718af_slowly(unsigned long a_u4Position)
{
	...
	DW9718AFDB("[DW9718AF] move_dw9718af_slowly g_u4CurrPosition=%ld,a_u4Position=%ld\n",g_u4CurrPosition,a_u4Position);
	while(pos_offset > AF_MOVE_STEP)
	{
		...
		s4DW9718AF_WriteReg((unsigned short)g_u4CurrPosition);
...
void initdrv()
{
	...
	char puSendCmd3[2] = { 0x05, 0x74 };//yixuhong 20150820 modify 0x65
