...
static int __init mt65xx_leds_init(void)
{
	...
	LEDS_DRV_DEBUG("[LED]%s\n", __func__);
#ifdef GPIO_PCHG_LED_EN
	mt_set_gpio_mode(GPIO_PCHG_LED_EN,GPIO_MODE_00);
	mt_set_gpio_dir(GPIO_PCHG_LED_EN,GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_PCHG_LED_EN,GPIO_OUT_ONE);
#endif
#ifdef CONFIG_OF
